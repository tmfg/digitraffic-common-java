package fi.livi.digitraffic.common.config;

import static fi.livi.digitraffic.common.util.TimeUtil.isoLocalDateToHttpDateTime;
...
import fi.livi.digitraffic.common.controller.ApiDeprecations;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;

public class DeprecationInterceptor implements HandlerInterceptor {

    private final static Logger log = LoggerFactory.getLogger(fi.livi.digitraffic.common.config.DeprecationInterceptor.class);
